function RenderThongTinDonHang() {
    ...
    function RenderHTML(){
        ...
        function Email(){
            for(var i in EmailDonHang){
                return EmailDonHang[i].email
            }  
        }
        ...
        function ViTri(a,b,c){
            for(var i in getData){
                if(EmailDonHang.email == getData[i].email){
                    console.log(getData[i].email)
                }
            }
        }
        var gg=getData.reduce(function(a,b,c){
            var Email=EmailDonHang
            console.log(Email)
            if (a){
                console.log(a.email)
            }
