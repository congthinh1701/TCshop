...
Validator.DangNhapEmail=function(selector,getThongTin,message){
    return {
        ...
        test:function(value){
            ...
            var isSuccess=getData.some(function(data,index){ 
                if (data.email == value){   
                    return index
                }
    ...
    return {
        ...
        test:function(value){
            ...
            for (var i in getData){
                if (getData[i].email==a){
                    var DoiTuongCuaEmail=getData[i]
                    return DoiTuongCuaEmail
                }
            }
            console.log(DoiTuongCuaEmail)
            var isSuccess=getData.forEach(function(data,index){ 
                //console.log(data,index)
                return data.password == value
            })

            return value = isSuccess ? undefined : message|| 'Password không hợp lệ'
        }
    }
}
