...
var Deal=function(){
    ...
    '                        <p class="time"> Thời gian còn lại: <span id="countdown"></span></p>                       \n'+
...
var productMan=function(){
    for (var i in listProduct){
        var data = listProduct[i]
            render="";
            render = '<div class="row productsMan products active1" id="sanphamNam">\n'+
            '                        <div class="col-12 col-xl-5 col-lg-8 col-md-10 col-sm-12 productMan-left">                      \n'+
            ...
            '                                </div>                       \n'+
            '                                <div>\n'+
            '                                    <p class="nameProduct" >Quần jean dài nổi bật</p>\n'+
            '                                    <p class="price">880.000đ</p>                           \n'+
            '                                </div>                              \n'+
            '                        </div>\n'+
            '    \n'+
            '                        <div class="col-12 col-xl-6 col-lg-9 col-md-12 col-sm-12  productMan-right" id="sanphamNamAll">\n'+
            '                            <div class="card">\n'+
            '                                <div class="tabs-img">\n'+
            '                                   <div class="tab-pane active">\n'+
            '                                        <img class="card-img-top" src="assets/img/bosutapnam/kaki1.jpg" alt="Card image cap">\n'+
            '                                        <div class="overlay">\n'+
            '                                            <button type="button" class="btn btn-warning">Add to card</button>\n'+
            '                                        </div>\n'+
            '                                   </div>\n'+
            '                                   <div class="tab-pane">\n'+
            '                                        <img class="card-img-top" src="assets/img/bosutapnam/kaki2.jpg" alt="Card image cap">\n'+
            '                                        <div class="overlay">\n'+
            '                                            <button type="button" class="btn btn-warning">Add to card</button>\n'+
            '                                        </div>\n'+
            '                                    </div>\n'+
            '                                    <div class="tab-pane">\n'+
            '                                        <img class="card-img-top" src="assets/img/bosutapnam/kaki3.jpg" alt="Card image cap">\n'+
            '                                        <div class="overlay">\n'+
            '                                            <button type="button" class="btn btn-warning">Add to card</button>\n'+
            '                                        </div>\n'+
            '                                   </div>\n'+
            ...
            '                                        <p class="card-title">Quần kaki New York</p>\n'+
            '                                        <p class="card-price">1.100.000đ</p>\n'+
            '                                    </div>                            \n'+
            '                                  <div class="tabs">\n'+
            '                                    <div class="tab-item active">\n'+
            '                                        <img src="assets/img/bosutapnam/kaki1.jpg">\n'+
            '                                    </div>\n'+
            '                                    <div class="tab-item ">\n'+
            '                                        <img src="assets/img/bosutapnam/kaki2.jpg">\n'+
            '                                    </div>\n'+
            '                                    <div class="tab-item ">\n'+
            '                                        <img src="assets/img/bosutapnam/kaki3.jpg">\n'+
            '                                    </div>\n'+
            '                                  </div>\n'+
            '                                </div>\n'+
            '                            </div>\n'+
