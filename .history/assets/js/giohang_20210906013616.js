...
function RenderGioHang(){
    ...
    render=""
    for (var i in DanhSachItemGioHang){
        data=DanhSachItemGioHang[i]
        render='<div class="product-image">\n'+
        '                    <img src="assets/img/bosutapnam/khoacmu3.jpg">\n'+
        '                </div>\n'+
        ...
        '                    </button>\n'+
        '                </div>\n'+
        '                <div class="product-line-price"><span style="color: #ffac4b;">25.98</span></div>';
